...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="vovo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC4vovo11AppDelegate")
...
SWIFT_CLASS("_TtC4vovo21AudioRecordingManager")
@interface AudioRecordingManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC4vovo16WebSocketManager")
...
@interface WebSocketManager (SWIFT_EXTENSION(vovo)) <NSURLSessionWebSocketDelegate>
